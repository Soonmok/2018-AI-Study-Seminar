...
class GameState:
    ...
    def __init__(self):
        ...
        self.barricade = Barricade(screen, 100, 100, SCREEN_WIDTH, SCREEN_HEIGHT)
        self.barricade2 = Barricade(screen, 200, 200, SCREEN_WIDTH, SCREEN_HEIGHT)
        self.terminate = Terminate(screen,  SCREEN_WIDTH, SCREEN_HEIGHT)
        self.timer = 0
    ...
    def frame_step(self, input_actions):
        ...
        reward = -(get_distance(self.character.location, self.terminate.location)/ 100000 + self.timer * 0.00001)
